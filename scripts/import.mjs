...
function prompt(url) {
  return [
    ...
    "4. compute_price once. If it returns `fixed_ladder`, pass every tier it lists as",
    "   `bundles` - one variant per tier, French titles (\"1 flacon\", \"2 flacons\",",
    "   \"3 flacons\"), each at the price given. Ignore the competitor's prices entirely.",
    "   Otherwise use the single price it returns. Then create_product with those French",
    "   fields, that price, and",
