...
function prompt(url) {
  return [
    ...
    "4. If the competitor sells bundles (1 / 2 / 3 units at different prices), call",
    "   compute_price for EACH tier and pass them as `bundles` - French titles like",
    "   \"1 flacon\", \"2 flacons\", \"3 flacons\" - so each is a real variant at its own",
    "   price. Otherwise call compute_price once for the single price. Then create_product",
    "   with those French fields, that price, and",
