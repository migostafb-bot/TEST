...
function prompt(url) {
  return [
    ...
    "   Keep origin and regulatory claims TRUE: never say a product is made in France or",
    "   approved by a French or EU body when it is not. Reword to drop the country",
    "   instead - \"certified US facilities\" becomes \"installations certifiées\" - and",
    "   drop US-only legal disclaimers, noting that in the CLAIMS line.",
